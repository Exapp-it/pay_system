                    ...
                    <div
                        ...
                        <div class="lg:flex pt-5">
                            <div class="px-2 py-4 lg:w-1/2">
                                <div class="relative">
                                    <input type="text" name="title" id="title" value="{{ $merchant->title }}"
                            ...
                            <div class="px-2 py-4 lg:w-1/2">
                                <div class="relative">
                                    <input type="text" id="base_url" value="{{ $merchant->base_url }}" disabled
                                        class="peer w-full py-2 border-2 border-gold-200 rounded-md focus:ring-1 focus:ring-gold-300 focus:border-gold-300 focus:outline-none placeholder-transparent">
                                    <label for="base_url"
                                        class="text-neutral-500 text-sm font-semibold  absolute -top-4 left-2 -translate-y-1/2 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600">
                                        {{ __('Домен') }}
                        ...
                        <div class="lg:flex">
                            <div class="px-2 py-4 lg:w-1/2">
                                <div class="relative">
                                    <input type="text" id="m_id" value="{{ $merchant->m_id }}" disabled
                                        class="peer w-full py-2 border-2 border-gold-200 rounded-md focus:ring-1 focus:ring-gold-300 focus:border-gold-300 focus:outline-none placeholder-transparent">
                                    <label for="m_id"
                                        class="text-neutral-500 text-sm font-semibold  absolute -top-4 left-2 -translate-y-1/2 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600">
                                        {{ __('ID') }}
                            ...
                            <div class="px-2 py-4 lg:w-1/2">
                                <div class="relative">
                                    <input type="text" name="m_key" id="m_key" value="{{ $merchant->m_key }}"
                                        class="peer w-full py-2 border-2 border-gold-200 rounded-md focus:ring-1 focus:ring-gold-300 focus:border-gold-300 focus:outline-none placeholder-transparent">
                                    <label for="m_key"
                                        class="text-neutral-500 text-sm font-semibold  absolute -top-4 left-2 -translate-y-1/2 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600">
                                        {{ __('Ключ') }}
                        ...
                        <div class="lg:flex">
                            ...
                            <div class="px-2 py-4 lg:w-1/3">
                                <div class="relative">
                                    <input type="text" name="fail_url" id="fail_url" value="{{ $merchant->fail_url }}"
                                        class="peer w-full py-2 border-2 border-gold-200 rounded-md focus:ring-1 focus:ring-gold-300 focus:border-gold-300 focus:outline-none placeholder-transparent">
                                    <label for="fail_url"
                                        class="text-neutral-500 text-sm font-semibold  absolute -top-4 left-2 -translate-y-1/2 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600">
                            ...
                            <div class="px-2 py-4 lg:w-1/3">
                                <div class="relative">
                                    <input type="text" name="handler_url" id="handler_url"
                        ...
                        <div class="lg:flex">
                            <div class="px-2 py-4">
                                <div class="relative">
                                    ...
                                    <label for="phone"
                                        class="text-neutral-500 text-sm font-semibold  absolute -top-4 left-2 -translate-y-1/2 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600">
                                        {{ __('Номер телефона (WhatsApp)') }}
                                    </label>
                                    <span class="text-neutral-500 px-3 text-sm">Формат (+XXXXXXXXXXXXX)</span>
                                </div>
                            </div>
                        </div>
